...
<xsl:stylesheet
    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM-file">
        ...
        <div class="item-metadata media-body" >
            ...
            <xsl:if test="dim:field[@element='publicationDate' and @mdschema='heal']">
                <div class="media-detail">
                    <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-publication-date</i18n:text><xsl:text>:</xsl:text></span>
                    <span>
                        <xsl:value-of select="substring(dim:field[@element='publicationDate' and @mdschema='heal']/node(),1,10)"/>
                    </span>
                </div>
            </xsl:if>
            <xsl:if test="dim:field[@element='dateCreated' and @mdschema='heal']">
                <div class="media-detail">
                    <span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-create-date</i18n:text><xsl:text>:</xsl:text></span>
                    <span>
                        <xsl:value-of select="substring(dim:field[@element='dateCreated' and @mdschema='heal']/node(),1,10)"/>
                    </span>
                </div>
            </xsl:if>
        </div>
