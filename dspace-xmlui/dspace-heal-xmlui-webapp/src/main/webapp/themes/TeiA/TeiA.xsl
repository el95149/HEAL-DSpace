...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="lib/xsl/aspect/general/modify-discovery.xsl"/>
    ...
    <xsl:import href="lib/xsl/aspect/myir/favorites.xsl"/>
    <xsl:import href="lib/xsl/aspect/myir/profiles.xsl"/>
