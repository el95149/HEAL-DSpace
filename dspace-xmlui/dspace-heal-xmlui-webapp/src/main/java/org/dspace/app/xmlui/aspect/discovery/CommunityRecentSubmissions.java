...
public class CommunityRecentSubmissions extends AbstractRecentSubmissionTransformer {
    ...
    private static final Message T_head_recent_submissions_hint =
                message("xmlui.ArtifactBrowser.SiteViewer.head_recent_submissions_hint");
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        if (0 < queryResults.getDspaceObjects().size()) {
            ...
            lastSubmittedDiv.addPara(T_head_recent_submissions_hint);
