...
importClass(Packages.com.imc.dspace.myir.EPersonProfile);
...
function updateInformation(eperson) 
{
    ...
    var profession = cocoon.request.getParameter("profession");
    var affiliation = cocoon.request.getParameter("affiliation");
    var websiteUrl = cocoon.request.getParameter("website_url");
    var isPublic = cocoon.request.getParameter("is_public");

    var setPublic = isPublic != null && isPublic.equals("1");
    ...
    EPersonProfile.update(getDSContext(), eperson.getID(), profession, affiliation, websiteUrl, setPublic);
