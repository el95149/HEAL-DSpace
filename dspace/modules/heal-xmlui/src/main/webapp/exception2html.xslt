...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="statusCode">404</xsl:param>
    ...
    <html>
      <head>
        ...
        <!--<meta http-equiv="refresh">-->
          ...
          <!--<xsl:value-of select="concat('0; url=', $contextPath, '/page/', $statusCode)"/>-->
          <!--</xsl:attribute>-->
        <!--</meta>        -->
        <style>
      ...
      <body>
        <xsl:attribute name="onload">
          ...
          <xsl:if test="ex:full-stacktrace">toggle('full-stacktrace');</xsl:if>
            //window.location = "<xsl:value-of select="$contextPath"/>/page/error400";
        </xsl:attribute>
